...
3. **Replace only the SVG icon** with the emoji (👋)
...
**Approach:** Used `button.innerHTML = '👋'` to replace the entire button content with just the emoji
...
7. Set span text content to '👋' emoji
